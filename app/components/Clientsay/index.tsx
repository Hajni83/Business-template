    ...
    return (
        <div className="mx-auto max-w-2xl py-40 px-4s sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="bg-image-what">
                <h3 className='text-navyblue text-center text-4xl lg:text-6xl font-semibold'>What clients say about us.</h3>
                <h4 className="text-lg font-normal text-darkgray text-center mt-4">Join thousands of satisfied users who have transformed their <br /> financial journey with our innovative platform.</h4>
