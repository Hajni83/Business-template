            ...
            <div className="mx-auto max-w-2xl lg:max-w-7xl bg-blue-500 rounded-3xl">
                <div className="grid grid-cols-1 gap-y-10 gap-x-6 lg:grid-cols-2 xl:gap-x-8">
                    ...
                    <div className="p-10 flex flex-col justify-center">
                        ...
                        <h4 className="text-base font-normal mb-7 text-offwhite">Stay updated with market insights, financial tips, and exclusive offers delivered to your inbox weekly.</h4>
